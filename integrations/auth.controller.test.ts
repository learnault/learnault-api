...
describe('AuthController', () => {
    ...
    describe('register', () => {
        ...
        it('should return 409 if user already exists', async () => {
            ...
            expect(mockResponse.json).toHaveBeenCalledWith({ error: 'User with this email or username already exists' })
        })
    })
    ...
    describe('logout', () => {
        it('should return success message', async () => {
            ...
            expect(mockResponse.status).toHaveBeenCalledWith(200)
            expect(mockResponse.json).toHaveBeenCalledWith({ message: 'Logged out successfully. Please clear your token client-side.' })
        })
    })
})
