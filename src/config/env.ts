...
export const env = {
  ...
  RATE_LIMIT_OTP_WINDOW_MS: parseInt(
    process.env.RATE_LIMIT_OTP_WINDOW_MS || '900000',
    10,
  ), // 15 minutes
  ...
  DELETION_COOLING_OFF_DAYS: parseInt(
    process.env.DELETION_COOLING_OFF_DAYS || '30',
    10,
  ),
  EXPORT_TTL_DAYS: parseInt(process.env.EXPORT_TTL_DAYS || '7', 10),
  LIFECYCLE_SWEEP_INTERVAL_MS: parseInt(
    process.env.LIFECYCLE_SWEEP_INTERVAL_MS || '0',
    10,
  ),
